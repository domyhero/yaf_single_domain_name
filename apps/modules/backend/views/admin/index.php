...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addAdmin', '<?php echo YUrl::createBackendUrl('Admin', 'add'); ?>', '添加管理员', 450, 240)"><em>添加管理员</em></a>
						...
						<div class="explain-col">
							<p style="margin-top: 10px;">
								<input type="text" value="<?php echo $keywords; ?>"
									class="input-text" name="keywords" placeholder="管理员名称或账号" /> <input

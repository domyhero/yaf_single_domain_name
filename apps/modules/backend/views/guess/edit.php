...
<div class="pad_10">
	<form action="<?php echo YUrl::createBackendUrl('Guess', 'edit'); ?>" method="post" name="myform" id="myform">
		<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
			<tr>
				<th width="100">竞猜标题：</th>
				<td><input type="text" name="title" id="title" size="30" class="input-text" value="<?php echo htmlspecialchars($detail['title']); ?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="deadline" id="deadline" size="20" class="date input-text" value="<?php echo $detail['deadline']; ?>"></td>
			</tr>
			<tr>
				<th width="100">是否开奖：</th>
				<td>
					<select name="is_open">
						<option <?php echo $detail['is_open']==0 ? 'selected="selected"' : ''; ?> value="0">否</option>
						<option <?php echo $detail['is_open']==1 ? 'selected="selected"' : ''; ?> value="1">是</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td><select>
					...
					<option <?php $detail['open_result']==$opk ? 'selected="selected"' : ''; ?> value="<?php echo $opk; ?>"><?php echo $opv; ?></option>
					<?php endforeach; ?>
				</select></td>
			</tr>
			<tr>
				...
				<td>
					...
					<p style="padding-top: 10px;">
						...
						<input type="text" name="options_data[<?php echo $opk; ?>][op_odds]" size="5" class="input-text" value="<?php echo $detail['option_data'][$opk]['op_odds']; ?>">[<?php echo $opv; ?>赔率]
					</p>
					<?php endforeach; ?>
				</td>
			</tr>
			<tr>
				<td width="100%" align="center" colspan="2">
					...
					<input type="hidden" name="guess_id" value="<?php echo $detail['guess_id']; ?>" />
				</td>
			</tr>
		</table>

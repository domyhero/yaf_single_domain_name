...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addIpBan', '<?php echo YUrl::createBackendUrl('Ip', 'add'); ?>', '添加IP黑名单', 400, 140)"><em>添加IP黑名单</em></a>
						...
						<div class="explain-col">
							<p style="margin-top: 10px;">
								<input type="text" value="<?php echo $keywords; ?>"
									class="input-text" name="keywords" placeholder="IP地址" /> <input
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
						...
						<td align="center"><a href="###"
							onclick="edit(<?php echo $item['id'] ?>, '<?php echo $item['ip'] ?>')"
							title="修改">修改</a> | <a href="###"
							onclick="deleteDialog('deleteIp', '<?php echo YUrl::createBackendUrl('Ip', 'delete', ['id' => $item['id']]); ?>', '<?php echo $item['ip'] ?>')"
							title="删除">删除</a></td>
					</tr>
    <?php endforeach; ?>
    </tbody>

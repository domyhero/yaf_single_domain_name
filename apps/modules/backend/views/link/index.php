...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addLink', '<?php echo YUrl::createBackendUrl('Link', 'add'); ?>', '添加友情链接', 400, 300)"><em>添加友情链接</em></a>
						...
						<div class="explain-col">
							<p style="margin-top: 10px;">
								<input type="text" value="<?php echo $keyword; ?>"
									class="input-text" name="keyword" placeholder="友情链接名称" /> <input
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
						...
						<td align="center"><img width="60"
							src="<?php echo $item['image_url'] ? YUrl::filePath($item['image_url']) : ''; ?>" /></td>
						<td align="center"><?php echo $item['cat_name']; ?></td>
						...
						<td align="center"><a href="###"
							onclick="edit(<?php echo $item['link_id'] ?>, '<?php echo $item['link_name'] ?>')"
							title="修改">修改</a> | <a href="###"
							onclick="deleteDialog('deleteLink', '<?php echo YUrl::createBackendUrl('Link', 'delete', ['link_id' => $item['link_id']]); ?>', '<?php echo $item['link_name'] ?>')"
							title="删除">删除</a></td>
					</tr>
    <?php endforeach; ?>
    </tbody>

					...
					<td>
						<div class="explain-col">
							<p style="margin-top: 10px;">
								错误码： <input type="text"
									value="<?php echo $search['errcode']; ?>" class="input-text"
									name="errcode" placeholder="" /> 日志类型： <select name="log_type">
									<option value="-1">不限</option>
								</select> 用户类型： <select name="log_type">
									<option value="-1">不限</option>
								</select> <input type="text" value="" class="input-text"
									name="log_user" placeholder="账号名称" /> 下单时间：<input type="text"
									name="starttime" id="starttime"
									value="<?php echo $search['starttime']; ?>" size="20"
									class="date input-text" /> ～ <input type="text" name="endtime"
									id="endtime" value="<?php echo $search['endtime']; ?>"

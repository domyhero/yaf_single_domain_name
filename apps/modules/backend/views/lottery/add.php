...
<div class="pad_10">
	<form action="<?php echo YUrl::createBackendUrl('Lottery', 'add'); ?>" method="post" name="myform" id="myform">
		<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
			<tr>
				<th width="100">活动名称：</th>
				<td><input type="text" name="title" id="title" size="50" class="input-text" value=""></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="bet_number" id="bet_number" size="40" class="input-text" value=""></td>
			</tr>
			<tr>
				<th width="100">人数上限：</th>
				<td><input type="text" name="person_limit" id="person_limit" size="10" class="input-text" value=""></td>
			</tr>
			<tr>
				<th width="100">开放参与时间：</th>
				<td><input type="text" name="open_apply_time" id="open_apply_time" size="20" class="date input-text" value=""></td>
			</tr>
			<tr>
				<th width="100">领取时间：</th>
				<td>
				  <input type="text" name="start_time" id="start_time" size="20" class="date input-text" value=""> 至

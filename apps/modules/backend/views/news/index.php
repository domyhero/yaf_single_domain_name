...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addNews', '<?php echo YUrl::createBackendUrl('News', 'add'); ?>', '添加文章', 900, 500, '', 'yes')"><em>添加文章</em></a>
...
function edit(id, name) {
	...
	postDialog('editNews', page_url, title, 900, 500, '', 'yes');
}
</script>
</body>
</html>
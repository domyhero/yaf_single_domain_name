...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addSensitive', '<?php echo YUrl::createBackendUrl('Sensitive', 'add'); ?>', '添加敏感词', 350, 120)"><em>添加敏感词</em></a>
						...
						<div class="explain-col">
							<p style="margin-top: 10px;">
								<input type="text" value="<?php echo $keywords; ?>"
									class="input-text" name="keywords" placeholder="请输入敏感词" /> <input
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
						...
						<td align="center"><a href="###"
							onclick="edit(<?php echo $item['id'] ?>, '<?php echo $item['val'] ?>')"
							title="修改">修改</a> | <a href="###"
							onclick="deleteDialog('deleteSensitive', '<?php echo YUrl::createBackendUrl('Sensitive', 'delete', ['id' => $item['id']]); ?>', '<?php echo $item['val'] ?>')"
							title="删除">删除</a></td>
					</tr>
    <?php endforeach; ?>
    </tbody>
